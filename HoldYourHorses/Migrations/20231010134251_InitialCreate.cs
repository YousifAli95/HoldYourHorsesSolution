        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TreeDensity = table.Column<int>(type: "int", nullable: false),
                    ...
                    AbsBrake = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Articles", x => x.ArticleNr);
                    table.UniqueConstraint("AK_Articles_ArticleName", x => x.ArticleName);
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Articles_OriginCountries_OriginCountryId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Favourites_Articles_ArticleNr",
                        column: x => x.ArticleNr,
                        principalTable: "Articles",
                        principalColumn: "ArticleNr");
                    table.ForeignKey(
                        name: "FK_Favourites_AspNetUsers_User",
                        column: x => x.User,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OrderLines_Articles_ArticleName",
                        column: x => x.ArticleName,
                        principalTable: "Articles",
                        principalColumn: "ArticleName");
                    table.ForeignKey(
                        name: "FK_OrderLines_Articles_ArticleNr",
                        column: x => x.ArticleNr,
                        principalTable: "Articles",
                        principalColumn: "ArticleNr");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Articles_OriginCountryId",
                table: "Articles",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderLines_ArticleName",
                table: "OrderLines",
                column: "ArticleName");

            migrationBuilder.CreateIndex(
                name: "IX_OrderLines_ArticleNr",
                table: "OrderLines",
                column: "ArticleNr");
